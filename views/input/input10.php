        ...
        <div class="col-md-8">
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal" method="post"  action="/input/input10">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Đề bài</label>
                ...
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Câu hỏi</label>

                  <div class="col-sm-10">
                    <input  class="form-control" id="inputEmail3" name="question_sub" placeholder="question">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input  class="form-control" id="inputEmail3" name="part" placeholder="mondai" value="10">
                  </div>
                </div>
                 <div class="form-group">
